/// string_wrap_map(string,width,break,split)
//
...
/// GMLscripts.com/license
    ...
    var pos_space, pos_current, text_current, text_output, mp,lst;
    pos_space = -1;
    pos_current = 1;
    text_current = argument0;
    if (is_real(argument2)) argument2 = chr(10);
    text_output = "";
    while (string_length(text_current) >= pos_current) {
        ...
        if (c == ' ' || c == '-') pos_space = pos_current;
        if (c == chr(9)) pos_current+=5;
        pos_current += 1;
    }
